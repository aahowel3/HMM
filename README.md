...
###Rerunning some of this in /work/aahowel3/HMM2 with the new bam files from /work/Alignments - any files referenced here are copied from original HMM folder 
HMM_dataprocessing.sh in HMM2 is just samtools depth command - alignments already generated by alignment scripts in /Alignemnts folder
New primary file is ancestors_mic_aligned_coverage.txt
